function createMatch(player1, hour, player2) {
  return `
    <li>
      <img src="./assets/icon-${player1}.svg" alt="${player1}'s flag" />
      <strong>${hour}</strong>
      <img src="./assets/icon-${player2}.svg" alt="${player2}'s flag" />
    </li>
  `
}
...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    ...
    createMatch("switzerland", "07:00", "cameroon") +
      createMatch("uruguay", "10:00", "korea") +
  ...
  createCard(
    ...
    createMatch("japan", "07:00", "costa-rica") +
      createMatch("belgium", "10:00", "morocco") +
  ...
  createCard(
    ...
    createMatch("croatia", "12:00", "belgium") +
      createMatch("canada", "12:00", "morocco") +
  ...
  createCard(
    "02/12",
    "sexta",
    createMatch("korea", "12:00", "portugal") +
